...
%
% Element-wise heritability estimation by LR-SD and heritability inference 
% with likelihood ratio test (LRT).  
% 
% The LRT statistic is chosen as the test statistic rather than h2
% estimator as h2 estimator is not sufficient or pivotal while LRT
% statistic is pivotal.  The distribution of LRT statistic does not
...
% Summary statistics: mean, wh2, median, q3, mean(h2>median), mean(h2>q3)
...
% Summary statistics: mean, wc2, median, q3, mean(c2>median), mean(c2>q3)
...
% Summary statistics: mean, we2, median, q3, mean(e2>median), mean(e2>q3)
